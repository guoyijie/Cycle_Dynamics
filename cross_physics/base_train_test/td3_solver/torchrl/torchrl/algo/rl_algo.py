...
class RLAlgo():
    ...
    def __init__(
        ...
        self.training_episode_successes = deque(maxlen=30)
    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            temp_counter = 0
            temp_succ_counter = 0
            print(training_epoch_info['train_success_es'])
            for train_success in training_epoch_info['train_success_es']:
                for each_train_success in train_success:
                    print(each_train_success)
                    temp_counter += 1
                    if each_train_success:
                        temp_succ_counter += 1

            if temp_counter > 0:
                self.training_episode_successes.append(temp_succ_counter/temp_counter)
            # print(self.training_episode_successes)
            ...
            if epoch % self.eval_interval == 0:
                ...
                infos["Train_Epoch_Success_Rate"] = np.mean(self.training_episode_successes)
