...
from cycle_transfer import ActionTransferAgent
...
if __name__ == "__main__":
	...
	parser.add_argument("--log_root", default="results_sil_transfer_raresil/")
	...
	parser.add_argument("--context_weight", default=0, type=float)
