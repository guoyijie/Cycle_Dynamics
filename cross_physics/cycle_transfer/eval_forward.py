...
class CycleData:
    ...
    def collect(self, data_id):
        ...
        now_path = os.path.join(data_folder,'../../push_data/push_3/now.npy')
        nxt_path = os.path.join(data_folder,'../../push_data/push_3/nxt.npy')
        act_path = os.path.join(data_folder,'../../push_data/push_3/act.npy')
        try:
            print(now_path)
